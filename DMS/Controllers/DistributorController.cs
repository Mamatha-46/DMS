...
namespace DMS.Controllers
{
    public class DistributorController : Controller
    {
       ...
       public async Task<IActionResult> AgreementDetails1(int? DisID)
        ...
        [HttpPost]
        public async Task<IActionResult> updatedocstatus([FromBody] DistDocView dic, DistributorViewmodel model)
        {
            ...
            if (busStatus == 1 && taxStatus == 1)
            {
                ...
                string mailMessage = $@"<html>
                        <body>
                            <font size=2 face=Verdana color=#000080>
                                <p align=left><b>Dear {model.DistributorName},</b></p>
                                ...
                                <p align=left><b>Reason: </b> {dic.Remarks}</p>
                                <p align=left><b><u>Tax Document:</u></b></p>
                                <p align=left><b>Status: </b> Approved</p>
                                <p align=left><b>Reason: </b> {dic.BRemark}</p>
                                ...
                                <img src='cid:logo' alt='logo' height='60' width='200' /><br><br>
                ...
                await SendEmail(model.Email, subject, mailMessage);
            }
            else if (busStatus == 0 && taxStatus == 0)
            {
                ...
                await SendEmail(model.Email, subject, emailBody);
            }
